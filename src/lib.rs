...
use controller::routes::{announcement::get_announcement_router, auth::get_auth_router, board::get_board_router, chat::get_chat_router, game::get_game_router, home::get_home_router, inquery::get_inquery_router, openapi::get_openapi_route, user::get_user_router };
